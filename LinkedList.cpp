...
void removeBefore(List*& L, int val)
{
    if (IsEmptyList(L) || L->p_head->p_next == nullptr) return;
...
int main()
{
    ...
    //printList(expectedList16);
    //std::cout << "\n";
    //if (!areListsEqual(reversedList16, expectedList16)) {
    //    std::cout << "FAILED TEST CASE 1\n";
    //    std::cout << "Expected: ";
    //    printList(expectedList16);
    //    std::cout << "\nGot: ";
    //    printList(reversedList16);
    //    std::cout << "\n";
    //    assert(false);
    //}
    ...
    //printList(expectedList16_2);
    //std::cout << "\n";
    //if (!areListsEqual(reversedList16_2, expectedList16_2)) {
    //    std::cout << "FAILED TEST CASE 1\n";
    //    std::cout << "Expected: ";
    //    printList(expectedList16_2);
    //    std::cout << "\nGot: ";
    //    printList(reversedList16_2);
    //    std::cout << "\n";
    //    assert(false);
    //}
    ...
    //printList(expectedList16_3);
    //std::cout << "\n";
    //if (!areListsEqual(reversedList16_3, expectedList16_3)) {
    //    std::cout << " FAILED TEST CASE 1\n";
    //    std::cout << "Expected: ";
    //    printList(expectedList16_3);
    //    std::cout << "\nGot: ";
    //    printList(reversedList16_3);
    //    std::cout << "\n";
    //    assert(false);
    //}
